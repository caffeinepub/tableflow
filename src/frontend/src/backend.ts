...
export class Backend implements backendInterface {
    ...
    async addItemsToOrder(arg0: bigint, arg1: Array<OrderItem>): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.addItemsToOrder(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async addMenuItem(arg0: string, arg1: number, arg2: string, arg3: boolean, arg4: string, arg5: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async createOrder(arg0: bigint, arg1: string, arg2: Array<OrderItem>): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async markAllServed(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.markAllServed(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateMenuItem(arg0: bigint, arg1: string, arg2: number, arg3: string, arg4: boolean, arg5: string, arg6: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async updateOrderItemStatus(arg0: bigint, arg1: bigint, arg2: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.updateOrderItemStatus(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePaymentStatus(arg0: bigint, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
